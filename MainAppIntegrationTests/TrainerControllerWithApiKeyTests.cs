...
{
    public class TrainerControllerWithApiKeyTests : IClassFixture<WebApplicationFactory<Program>>//wspoldzielenie factory testy nieco szybsze
    {
        private IConfigurationSection _authSettings;
        private HttpClient _httpClient;

        public TrainerControllerWithApiKeyTests(WebApplicationFactory<Program> factory)
        {
